...
export const metadata = { title: "Privacy — TrueBasis" };
...
export default function Privacy() {
  return (
    <main className="min-h-screen bg-gray-950 text-gray-200 px-4 sm:px-8 py-8 max-w-3xl mx-auto text-sm leading-relaxed">
      ...
      <p className="mb-3">
        <strong>Your statement never leaves your browser.</strong> When you drop a file into TrueBasis it is read and
